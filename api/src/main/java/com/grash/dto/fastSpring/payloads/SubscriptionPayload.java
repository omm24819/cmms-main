...
@Data
@Schema(description = "FastSpring subscription webhook payload")
public class SubscriptionPayload {
    @Data
    @Schema(description = "Product details within a subscription payload")
    public static class Product {
        @Schema(description = "Product identifier")
        public String product;
        @Schema(description = "Parent product identifier")
        public Object parent;
        @Schema(description = "Product application reference")
        public String productAppReference;
        @Schema(description = "Fulfillment information for the product")
        public Fulfillments fulfillments;
        @Schema(description = "Product format type")
        public String format;
        @Schema(description = "Tax code for the product")
        public String taxcode;
        @Schema(description = "Description of the tax code")
    ...
    @Schema(description = "Account details for this subscription")
    ...
    @Schema(description = "Deactivation date")
    ...
    @Schema(description = "Product details for this subscription")
